...
\vspace{1cm}
Para executar o projeto, dentro do diretório workspace/tp1, utilize o comando de ajuda para ver as opções:

cabal run sl -- --help 

\vspace{1cm}
Ou, para executar os casos de teste automaticamente, utilize o comando: 

cabal run test

\vspace{1cm}
Caso queira utiliziar o analisador léxico:
cabal run sl -- --lexer <arquivo teste>

Caso queira utiliziar o analisador sintático:
cabal run sl -- --parser <arquivo teste>

Caso queira utiliziar o pretty printer:
cabal run sl -- --pretty <arquivo teste>
